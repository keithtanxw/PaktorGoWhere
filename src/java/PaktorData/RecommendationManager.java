...
public class RecommendationManager {
  ...
  private void handleSQLException(SQLException ex, String sql, String... parameters) {
    ...
    Logger.getLogger(RecommendationManager.class.getName()).log(Level.SEVERE, msg, ex);
   ...
   */
  public void addNewRecommendation(ArrayList<String> newUserDetails) {
   ...
   * @return List object.
   */
  public HashMap<String, ArrayList<String>> retrieveAllRecommendations() {
    Connection conn = null;
    PreparedStatement stmt = null;
    ResultSet rs = null;
    String sql = "";
  ...
  /**
   * Retrieve a information of a particular recommendation
   *
   * @param id
   * 
   * null.
   */
  public ArrayList<String> retrieveAParticularRecommendation(String username) {
    Connection conn = null;
    PreparedStatement stmt = null;
    ResultSet rs = null;
    String sql = "";
  ...
  //Handle queries for surprise me search
  public ArrayList<String> surpriseMe(){
      
      //container for results
      ArrayList<String> detailsOfSurpriseMe = new ArrayList<>();
      
      //Search algorithm
      
      return detailsOfSurpriseMe;
  }
