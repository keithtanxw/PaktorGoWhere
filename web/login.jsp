    ...
    <body>
        ...
        <div class="container-fluid">                
            <div class="row text-center" id="logoSection">
                <img src="PaktorGoWhere/img/appPics/app_logo.PNG" alt="" style="width:50%;height:auto"/>
            </div>
        </div>
        <div class="container-fluid" id="mainSection">
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                <div class="login-panel">
                    <div class="login-body text-center heading-09">
                        <form role="form">
                        ...
                        <div class="text-center">
                            <span class="heading-08">Do not have an account? <a href="#">Register now</a></span>
                        </div>
                    
                    </div>
                    <div class="login-footer text-center">
                        <span class="heading-08" style="color:#444">Sign in using social networks</span>
                        <br/>
